...
class TestPhase4SchemaTables:
    ...
    def test_schema_version_is_14(self):
        ...
        assert "_SCHEMA_VERSION = 14" in schema_content or "_SCHEMA_VERSION = 15" in schema_content or "_SCHEMA_VERSION = 16" in schema_content or "_SCHEMA_VERSION = 17" in schema_content
