...
class TestPhase5AgentsIntegration:
    ...
    def test_schema_version_is_15(self):
        ...
        assert "_SCHEMA_VERSION = 15" in schema_content or "_SCHEMA_VERSION = 16" in schema_content or "_SCHEMA_VERSION = 17" in schema_content or "_SCHEMA_VERSION = 18" in schema_content
