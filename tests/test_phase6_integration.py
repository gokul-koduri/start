...
class TestPhase6Integration(unittest.TestCase):
    ...
    def test_schema_version_16(self):
        ...
        self.assertTrue(
            "_SCHEMA_VERSION = 16" in schema_content or "_SCHEMA_VERSION = 17" in schema_content or "_SCHEMA_VERSION = 18" in schema_content or "_SCHEMA_VERSION = 19" in schema_content,
