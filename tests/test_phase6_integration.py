...
class TestPhase6Integration(unittest.TestCase):
    ...
    def test_auth_package_exists(self):
        ...
        self.assertTrue(
            (Path(__file__).parent.parent / "auth" / "__init__.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "auth" / "jwt_handler.py").exists()
        )
    ...
    def test_tenant_manager_exists(self):
        ...
        self.assertTrue(
            (Path(__file__).parent.parent / "auth" / "tenant_manager.py").exists()
        )

    def test_api_v2_exists(self):
        """Test API v2 routers exist."""
        self.assertTrue(
            (Path(__file__).parent.parent / "api" / "v2" / "__init__.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "api" / "v2" / "opportunities.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "api" / "v2" / "signals.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "api" / "v2" / "webhooks.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "api" / "v2" / "export.py").exists()
        )

    def test_webhooks_package_exists(self):
        """Test webhooks package exists."""
        self.assertTrue(
            (Path(__file__).parent.parent / "webhooks" / "__init__.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "webhooks" / "dispatcher.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "webhooks" / "templates.py").exists()
        )

    def test_monitoring_package_exists(self):
        """Test monitoring package exists."""
        self.assertTrue(
            (Path(__file__).parent.parent / "monitoring" / "__init__.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "monitoring" / "metrics.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "monitoring" / "health.py").exists()
        )
    ...
    def test_phase6_agents_exist(self):
        ...
        self.assertTrue(
            (
                Path(__file__).parent.parent / "agents" / "slack_integration_agent.py"
            ).exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "agents" / "email_digest_agent.py").exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "agents" / "export_agent.py").exists()
        )
        self.assertTrue(
            (
                Path(__file__).parent.parent / "agents" / "feed_generator_agent.py"
            ).exists()
        )
        self.assertTrue(
            (Path(__file__).parent.parent / "agents" / "data_quality_agent.py").exists()
        )
        self.assertTrue(
            (
                Path(__file__).parent.parent / "agents" / "pipeline_health_agent.py"
            ).exists()
        )
        self.assertTrue(
            (
                Path(__file__).parent.parent / "agents" / "cost_tracking_agent.py"
            ).exists()
        )
    ...
    def test_schema_version_16(self):
        ...
        self.assertGreaterEqual(
            get_schema_version(), 16, "Schema version should be >= 16"
        )
