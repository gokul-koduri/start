...
class TestRunValidation(unittest.TestCase):
    ...
    def test_confusion_matrix_sums_to_total(self):
        ...
        from scoring.validate import run_validation
        report = run_validation()
        total_cm = report.true_positives + report.false_positives + report.true_negatives + report.false_negatives
    ...
    def test_accuracy_at_least_50_percent(self):
        ...
        from scoring.validate import run_validation
        report = run_validation()
        self.assertGreaterEqual(report.accuracy, 50.0,
    ...
    def test_custom_threshold(self):
        ...
        self.assertGreaterEqual(report_low.true_positives + report_low.false_positives,
...
class TestSuggestWeightTuning(unittest.TestCase):
    ...
    def test_high_accuracy_no_tuning(self):
        ...
        from scoring.validate import suggest_weight_tuning, ValidationReport, ValidationResult
